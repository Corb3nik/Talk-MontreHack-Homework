            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Hello,everyone!<br/>For your homework, you need to draw a picture of your first lover!<br/>
                        Please complete this assignment!</li>
                    </ul>
                    <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <form action="upload.php" method="post" enctype="multipart/form-data">
                            <input class="file" type="file" name="pic" id="file" accept="image/*" >
                            <br/>
